...
return ( <section className="relative z-10 bg-[#CBDEEF] px-6 py-24 sm:px-10 lg:px-16 lg:py-36"> <div className="mx-auto max-w-7xl"> <div className="max-w-4xl"> <p className="font-body text-xs uppercase tracking-[0.2em] text-[#0783B6]">
Beyond the Room </p>
